...
class AppPlanningWorkflow:
    ...
    def generate_business_plan(self, app_idea: str, app_name: str) -> str:
        """Generate a business plan using the Tech Entrepreneur persona."""
        system_prompt = get_system_prompt("entrepreneur", "business_plan")
        prompt = format_prompt(
            "entrepreneur", "business_plan", app_idea=app_idea, app_name=app_name
        )
